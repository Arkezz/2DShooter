...
void MainWindow::settings() {
    ...
    //Connect the slider to the volumechanger in sound manager
    ...
    //Connect the mute button to the mute function in sound manager
    connect(muteButton, SIGNAL(clicked()), &music, SLOT(mute()));
